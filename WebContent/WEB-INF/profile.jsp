			...
			<div class="view">
				...
				<div class="content">
					<div class='login'>
						...
						<form method="post" action="/FileManagementSys/profile"
							modelAttribute="profiles">
							<input name="firstname" placeholder='First Name' type='text'
								required="" /> <input name="middlename"
								placeholder='Middle Name' type='text' required="" /> <input
								name="lastname" placeholder='Last Name' type='text' required="" />
							<input name="age" placeholder='Age' type='text' required="" /> <input
								name="phoneno" placeholder='Phone Number' type='text'
								required="" /> <input name="email" placeholder='Email'
								type='email' required="" /> <input name="photo"
								placeholder='Photo' type='file' required="" /> <input
								name="date_Hired" placeholder='Date' type='date' required=""
								data-date-format="YYYY MMM DD" /> <input name="attendance"
								placeholder='Attendance' type='text' required="" /> <input
								name="address" placeholder='Address' type='text' required="" />
							<input class='animated' name="Upload" type='submit'
								value='Upload'>
						</form>
					</div>
