			...
			<div class="nav">
				<div class="menu">
					...
					<ul>
						...
						<li><i class="fa fa-users"></i><a href="profileUpload">Add User</a></li>
					</ul>
				</div>
			</div>
			<div class="view">
				...
				<div class="content">
					<div class='login'>
 						...
 						<form method="post" action="/FileManagementSys/upload" modelAttribute="files">
  								<input name="contractno" placeholder='Contractno' type='text' required=""/>
  								<input name="filename" placeholder='File Name' type='text' required=""/>
  								<input name="accountno" placeholder='Account No' type='text' required=""/>
  								<input name="caption" placeholder='Caption' type='text' required=""/>
  								<input name="description" placeholder='Description' type='text' required=""/>
  								<input name="Handler" placeholder='Handler' type='text' required=""/>
  								<input name="pastdate" placeholder='Date' type='date' required="" data-date-format="YYYY MMM DD" />
  								<input name="choosefile" placeholder='Select File' type='file' size="40" required=""/>
  								<input class='animated' name="Upload" type='submit' value='Upload'>
  						</form>
						</div>
