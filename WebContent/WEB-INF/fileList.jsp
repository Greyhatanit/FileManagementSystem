					...
					<div id="demo">
						...
						<div class="table-responsive-vertical shadow-z-1">
							...
							<table id="table" class="table table-hover table-mc-light-blue">
								<tr>
									<td class="heading">Contract No</td>
									<td class="heading">File Name</td>
									<td class="heading">Account No</td>
									<td class="heading">Caption</td>
									<td class="heading">Description</td>
									<td class="heading">Path</td>
									<td class="heading">Handler</td>
									<td class="heading">Date Created</td>
									<td class="heading">Edit</td>
									<td class="heading">Delete</td>
								</tr>
								<c:forEach var="file" items="${fileList}">
									<tr>
										<td>${file.contractno}</td>
										<td>${file.filename}</td>
										...
										<td>${file.handler}</td>
										<td>${file.date}</td>
										<td><a href="edit?id=${file.contractno}">Edit</a></td>
										<td><a href="delete?id=${file.contractno}">Delete</a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
