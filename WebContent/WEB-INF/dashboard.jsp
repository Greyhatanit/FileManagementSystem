					...
					<div class="container">
						...
						<div class="chat-box">
							<div class="message-box left-img">
								<div class="picture">
									<img
										src="http://dribbble.s3.amazonaws.com/users/2493/avatars/original/joey_head_new.png?1346157876"
										title="user name" /> <span class="time">10 mins</span>
								</div>
								<div class="message">
							...
							<div class="message-box right-img">
								<div class="picture">
									<img
										src="http://dribbble.s3.amazonaws.com/users/212696/avatars/small/monogram_pixel_perfect.png?1359994784"
										title="user name" /> <span class="time">2 mins</span>
								</div>
								<div class="message">
							...
							<div class="enter-message">
								<input type="text" placeholder="Enter your message.." /> <a
									href="#" class="send">Send</a>
							</div>
						</div>
					</div>
				<!-- Ending of messages -->
